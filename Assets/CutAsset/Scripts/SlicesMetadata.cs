...
namespace Assets.Scripts
{
    ...
    class SlicesMetadata
    {
            ...
            for (int i = 0; i < meshTriangles.Length; i += 3)
            {
                ...
                else
                {
                    ...
                    else if (vert1Side == vert3Side)
                    {
                        ...
                        // Debug.Log("vert1: " + vert1 + " vert2: " + vert2 + " vert3: " + vert3 + " intersection1: " + intersection1 + " intersection2: " + intersection2);
        ...
        private Vector3 ComputeNormal(Vector3 vertex1, Vector3 vertex2, Vector3 vertex3)
        {
            ...
            // Vector3 vertexToFind = new Vector3(-0.5, -0.5, 0.5);
            // Debug.Log("vertex1: " + vertex1 + " vertex2: " + vertex2 + " vertex3: " + vertex3 + " side1: " + side1 + " side2: " + side2 + " normal: " + Vector3.Cross(side1, side2).normalized);
