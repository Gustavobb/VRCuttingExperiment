...
namespace Assets.Scripts
{
    class Slicer
    {
        ...
        {            
            ...
            positiveSliceable.gameObject.layer = sliceable.gameObject.layer;
            negativeSliceable.gameObject.layer = sliceable.gameObject.layer;

            positiveSliceable.Parent = sliceable.Parent;
            negativeSliceable.Parent = sliceable.Parent;

            positiveSliceable.joiner = sliceable.joiner;
            negativeSliceable.joiner = sliceable.joiner;
